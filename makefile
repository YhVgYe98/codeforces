...
.\$(prefix)$(name)\main.cc:
	mkdir $(prefix)$(name)
	@type .\solution_template\src\main.cc			>.\$(prefix)$(name)\main.cc
...
.\$(prefix)$(name)\src\main.rs:
	...
	@type .\solution_template\src\main.rs			>.\$(prefix)$(name)\src\main.rs
	@type .\solution_template\duipai.py			>.\$(prefix)$(name)\duipai.py
